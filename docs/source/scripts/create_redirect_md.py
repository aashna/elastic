...
that redirects http://pytorch.org/elastic/latest/<file_name>.html
to http://pytorch.org/elastic/<version>/<file_name>.html
"""
...
def parse_args(args):
    ...
    parser.add_argument("--source_dir", required=True, help="directory where rst files are")
...
if __name__ == "__main__":
    ...
    for rst_file in glob.glob(os.path.join(source_dir, "**/*.rst"), recursive=True):
        ...
        with open(md_file, "w") as f:
            ...
            f.write(f"redirect_url: \"/{build_ver}/{html_relative_path}\"\n")
            f.write("---\n")
